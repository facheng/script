...
def ticket_rob(cookie, get_coupon_url='https://a.jd.com/indexAjax/getCoupon.html', get_cate_url='https://a.jd.com/indexAjax/getCouponListByCatalogId.html?callback=jQuery4342914&catalogId=19&page=1&pageSize=9&_=1534521129630'):
    requestHeaders=get_request_header(cookie)
    send_code_url =get_coupon_url+'?callback=jQuery1355969&key=124a025297d236857b920e3e9cf74ecacacf0bd9781c4c9dec45480ad8e35f6e3ca93b4d768649c2d493709d29b3cbea&type=1&_=1534554679960'
    ...
    print now_timer
    sched_timer= datetime.datetime(2018,8,18,22,00,00,000100)
